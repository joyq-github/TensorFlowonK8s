...
Run *kubectl get svc* to get the service IP addresses of each ps and worker node, as shown below.
    tf-ps0       10.0.211.196   <none>        6006/TCP,2222/TCP   16m    
    tf-ps1       10.0.81.168    <none>        6006/TCP,2222/TCP   16m
    tf-worker0   10.0.221.23    <none>        6006/TCP,2222/TCP   1h
    tf-worker1   10.0.118.248   <none>        6006/TCP,2222/TCP   16m      
